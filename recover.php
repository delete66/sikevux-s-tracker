...
//	$md5 = $matches[2];
  ...
  $newpasshash = md5(sha512(sha512(md5(sha1("666SikevUxismymAsteroFcahdhe666RoxsobaDly666")))) . sha512($newpassword) . sha512("sikevuxistheshit") . $sec . $newpassword . $sec . sha512($salt) . sha256($salt2) . sha1($salt3) . sha512($salt3));
