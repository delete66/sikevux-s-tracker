...
?><h2 align="center">News<?
if ($CURUSER['class'] >= UC_ADMINISTRATOR)
{
?>&nbsp;-&nbsp;<font class='small'>[<a class='altlink' href='/news.php'><b>News</b></a>]</font><?
}
?></h2><?
...
{
?><a href="javascript: klappe_news('a<? echo $arr['id']; ?>')"><br><img border="0" src="pic/<? echo ($i > 0 ? 'plus' : 'minus'); ?>.gif" id="pica<? echo $arr['id']; ?>" alt="Show/Hide">&nbsp;<? echo gmdate("Y-m-d", strtotime($arr['added'])); ?> - <b><? echo ($arr['sticky']=="yes" ? "<img src='pic/sticky.gif' border='0' alt='sticky'>" : ""); ?>&nbsp;&nbsp;<? echo safeChar($arr['title']); ?></b><? echo ($i > 0 ? "&nbsp;&nbsp;Posted by&nbsp;".safeChar($arr['username']) : ''); ?></a><?
if ($CURUSER['class'] >= UC_ADMINISTRATOR)
{
?>&nbsp;<font size="-2"> &nbsp; [<a class='altlink' href='/news.php?action=edit&newsid=<? echo $arr['id']; ?>&returnto=<? echo urlencode($_SERVER['PHP_SELF']); ?>'><b>E</b></a>]</font><?
?>&nbsp;<font size="-2">[<a class='altlink' href='/news.php?action=delete&newsid=<? echo $arr['id']; ?>&returnto=<? echo urlencode($_SERVER['PHP_SELF']); ?>'><b>D</b></a>]</font><?
}
?><div id="ka<? echo $arr['id']; ?>" style="display: none;"><? echo format_comment($arr["body"], false); ?></div><?
}
?></ul></td></tr></table>
<?
}
...
ob_start(); // start the output buffer
?><table width='737' class='main' border='0' cellspacing='0' cellpadding='0'><tr><td class='embedded'><?
?><h2 align="center">Change Log<?
if ($CURUSER['class'] >= UC_SYSOP)
{
?>&nbsp;-&nbsp;<font class='small'>[<a class='altlink' href='/changelog.php'><b>Change Log</b></a>]</font><?
}
?></h2><?
...
if ($CURUSER['class'] >= UC_SYSOP)
{
?>&nbsp;<font size="-2"> &nbsp; [<a class='altlink' href='/changelog.php?action=edit&changelogid=<? echo $arr['id']; ?>&returnto=<? echo urlencode($_SERVER['PHP_SELF']); ?>'><b>E</b></a>]</font><?
?>&nbsp;<font size="-2">[<a class='altlink' href='/changelog.php?action=delete&changelogid=<? echo $arr['id']; ?>&returnto=<? echo urlencode($_SERVER['PHP_SELF']); ?>'><b>D</b></a>]</font><?
}
?><div id="ka<? echo $arr['id']; ?>" style="display: none;"><? echo format_comment($arr["body"], false); ?></div><?
}
?></ul></td></tr></table><?
...
{
?>
&nbsp;-&nbsp;<font class='small'>[<a class='altlink' href='/poller-admin.php'><b>Poll Admin</b></a>]</font><?
}
?></h2>
		...
		<tr>
			...
			<table border="1" cellpadding="5" cellspacing="0" class="main">
				...
				<tr>
					...
					<td align="right"><b><? echo $totalonline;?></b></td>
				</tr>
                	<tr>
					<td class="rowhead">Record</td>
					<td align="right"><b><? echo $rec['record'].' at '.$rec['date'];?></b></td>
				</tr>
				<tr>
...
<table border="1" cellpadding="10" cellspacing="0" width="760">
	<tr>
		...
		<p>Donations</p>
		<a href="donate.php">
		<img border="0" alt="Make A Donation" src="pic/makedonation.gif"></a><?
...
$totalneeded = "200";    //=== set this to your monthly wanted amount
...
?>
		...
		administrator of this site <? echo $BASEURL?> holds NO Responsibility
