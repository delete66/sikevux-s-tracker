<?php
//TODO Fixa alla fula felmedelanden
...
//die();
if (!mkglobal("wantusername:wantpassword:passagain:email:passhint:hintanswer"))
die();
session_start();
...
header("Refresh: 0; url=ok.php?type=". (!$arr[0]?"sysop":"confirm"));

?>
<META Refresh=0 url=ok.php?type="<?(!$arr[0]?"sysop":"confirm")?> >