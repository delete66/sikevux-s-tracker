...
<center><p> Note: You need cookies enabled to sign up or log in.</p></center>
<p>
...
<?php
  ...
  <tr>
    ...
    <td>
      ...
      <img class="cimage" src="/tracker/captcha/GD_Security_image.php?<?php //echo time(); ?>" alt="Captcha image" />
      </a>
      </div>
     </td>
  </tr>
...
<td colspan="2" align="center">
    <div style="width:100%; height:130px; overflow: auto" class="quickjump">
      <table width="100%"  border="0" cellspacing="2" cellpadding="2">
        <tr>
          <td width="75%"><strong>Sikevux's Tracker's Rules</strong>
                ...
                <tbody>
                  <tr>
                    <td><ul>
                      ...
                      <li>Do not use potentially offensive material involving childporn, religious material, animal / human  cruelty or ideologically charged images. Mods have wide discretion on what is acceptable.  If in doubt PM one. </li>
                    </ul></td>
                  </tr>
                </tbody>
              </table>
...
<input type=checkbox name=ageverify value=yes> I am at least 15 years old.</td></tr>
